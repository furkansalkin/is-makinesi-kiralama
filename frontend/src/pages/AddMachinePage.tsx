...
const AddMachinePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Makine eklenirken bir hata oluştu!')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 py-6 bg-gradient-to-r from-blue-600 to-blue-700">
            <h1 className="text-2xl font-bold text-white">Yeni Makine Ekle</h1>
            <p className="mt-2 text-blue-100">Makine bilgilerini eksiksiz doldurunuz</p>
          </div>
                ...
                <div className="space-y-2 text-center">
                  <div className="mx-auto h-24 w-24 text-gray-400">
                    {previewUrls.length === 0 ? (
                      ...
                      <img src={previewUrls[0]} alt="Önizleme" className="h-full w-full object-cover rounded-lg" />
                    )}
                  </div>
